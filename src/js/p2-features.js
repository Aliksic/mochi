...
(function () {
  ...
  const eatApp = makeApp('eat', '吃什么', '<svg viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 2.5v7c0 1.1.9 2 2 2h4c1.1 0 2-.9 2-2v-7"/><path d="M7.2 2.5v8.3"/><path d="M9.8 2.5v8.3"/><path d="M8.5 11.5v10"/><path d="M19.5 15V2.5a5 5 0 00-5 5v5.5c0 1.1.9 2 2 2h3z"/><path d="M19.5 15v6.5"/></svg>');
