...
const FIX_SENTINELS = [
  ...
  { name: '#199 判定器·浏览器覆盖形态期望底边=可视区底（.phone 刻意不超 inner，仍按 envTop+inner 判则修好后误报 #179 少填；#210 起判式收敛到共享判定器）', file: 'js/device.js', needle: 'const coverBrowser = !standalone && diff <= 2 && envTop >= 20;' },
